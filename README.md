...
### Notifications ###
DubzHud displays Notifications under the Modules line. Currently, 6 notifications are implemented: melee strength indicator, food saturation, and a low durability indicator for each armor piece. Notifications may be turned off in the config file, and colors can be changed as well.
